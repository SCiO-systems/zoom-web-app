var testTool = {
  ...
  getMeetingConfig: function (participantNumber) {
    console.log(participantNumber)
    return {
      mn: parseInt(localStorage.getItem("id")),
      name: testTool.b64EncodeUnicode(
        document.getElementById("nameParticipant["+participantNumber+"]").value
      ),
      pwd: localStorage.getItem("password") ,
      role: parseInt("0"),
      email: testTool.b64EncodeUnicode(
        document.getElementById("emailParticipant["+participantNumber+"]").value
      ),
      lang: "en-US",
      signature: "",
      china: "0",
  ...
  getMeetingConfigHost: function () {


    return {
      mn: parseInt(localStorage.getItem("id")),
      name: testTool.b64EncodeUnicode(localStorage.getItem("host_id") ),
      pwd: localStorage.getItem("password") ,
      role: parseInt("1"),
      email: testTool.b64EncodeUnicode(localStorage.getItem("host_email") ),
      lang: "en-US",
      signature: "",
      china: "0",
    };
